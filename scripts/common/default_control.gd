...
func getMouseFilter() -> Control.MouseFilter:
	assert(!mouse_nodes.is_empty(), "No mouse targets")
	return mouse_nodes[0].get_mouse_filter_with_override()
...
func onMouseInUI(state: bool) -> void:
	...
	var MainTarget: Control = getMainTarget()
...
func onUpdateModulate() -> void:
	...
	getMainTarget().modulate = _base_color
...
func getMainTarget() -> Control: return get_parent()
